...
@Component({
    ...
    <div class="page">
      <div class="page-header">
        ...
        <div class="header-actions">
          <input type="text" [(ngModel)]="search" (ngModelChange)="onSearch()" placeholder="Search amenities..." class="search-input">
        </div>
      </div>
        ...
        <table *ngIf="!loading">
          ...
          <tbody>
            ...
            <tr *ngIf="items.length === 0">
              <td colspan="4" class="empty">No amenities found</td>
            </tr>
          </tbody>
        </table>
  ...
  styles: [`
    ...
    .badge-active, .badge-available { background: #e8f5e9; color: #2e7d32; }
    .badge-inactive, .badge-closed { background: #ffebee; color: #c62828; }
...
export class AmenitiesComponent implements OnInit {
  ...
  loadData(): void {
    ...
    this.api.get<any>('/amenities', params).subscribe({
      next: (res) => {
        this.items = res.data?.amenities || res.data || [];
