...
@Component({
    ...
    <div class="page">
      <div class="page-header">
        ...
        <div class="header-actions">
          <input type="text" [(ngModel)]="search" (ngModelChange)="onSearch()" placeholder="Search members..." class="search-input">
        </div>
      </div>
        ...
        <table *ngIf="!loading">
          ...
          <tbody>
            ...
            <tr *ngIf="items.length === 0">
              <td colspan="4" class="empty">No committee members found</td>
            </tr>
          </tbody>
        </table>
  ...
  styles: [`
    ...
    .badge-inactive, .badge-removed { background: #ffebee; color: #c62828; }
...
export class CommitteeComponent implements OnInit {
  ...
  loadData(): void {
    ...
    this.api.get<any>('/committee', params).subscribe({
      next: (res) => {
        this.items = res.data?.members || res.data || [];
