    ...
    <div class="page">
      <div class="page-header">
        ...
        <div class="header-actions">
          <input type="text" [(ngModel)]="search" (ngModelChange)="onSearch()" placeholder="Search directory..." class="search-input">
        </div>
      </div>
        ...
        <table *ngIf="!loading">
          ...
          <tbody>
            ...
            <tr *ngIf="items.length === 0">
              <td colspan="4" class="empty">No directory entries found</td>
            </tr>
          </tbody>
        </table>
...
export class DirectoryComponent implements OnInit {
  ...
  loadData(): void {
    ...
    this.api.get<any>('/directory', params).subscribe({
      next: (res) => {
        this.items = res.data?.entries || res.data || [];
